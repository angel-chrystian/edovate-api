...
<cftry>
	<cfscript>
		errorObj = {};
		simpleQuery = queryExecute( "select top 2 entityName, created from mb_entity" );
	</cfscript>
<cfcatch>
	<cfset errorObj.simpleQuery = cfcatch />
</cfcatch>
...
<cfset orgID = 8450>
<cfset request.dsn = 'webbquickprod' />
<cfset request.db_user = 'sa' />
<cfset request.db_pw ='kvBQRF/DzNm+z;&' />

<div style="font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif'">

<h1>Get Parent Info</h1>
<cfquery name="getParent" datasource="#request.dsn#" username="#request.db_user#" password="#request.db_pw#" dbtype="ODBC">
select
...
<cfquery name="getParentTags" datasource="#request.dsn#" username="#request.db_user#" password="#request.db_pw#" dbtype="ODBC">
	select
...
<cfquery name="getStudents" datasource="#request.dsn#" username="#request.db_user#" password="#request.db_pw#" dbtype="ODBC">
select
...
<cfquery name="getStudent" datasource="#request.dsn#" username="#request.db_user#" password="#request.db_pw#" dbtype="ODBC">
select
...
<cfquery name="getStudentTags" datasource="#request.dsn#" username="#request.db_user#" password="#request.db_pw#" dbtype="ODBC">
	select
		rt.RelationType as tagName,
		rt.pk_RelationTypeId as tagID
...
<cfcatch>
	<cfset errorObj.legacyQueries = cfcatch />
	<cfdump var="#errorObj#"></cfcatch>
</cftry>
</cfoutput>